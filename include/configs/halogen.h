...
#define CONFIG_OKW_GP_SPI_ENABLE 22
#define CONFIG_OKW_GP_SPI_CLK 117
#define CONFIG_OKW_GP_SPI_DATA 118
...
#if (PLATFORM_TYPE==MICROAVL)
#define CFG_ENV_ADDR		   ((CFG_FLASH_BASE)+(1<<18))	/* Environment Sector at base+256k */
#else
