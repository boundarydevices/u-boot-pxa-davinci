...
#define CONFIG_BOOTCOMMAND	"if mmcinit || mmcinit ; then if fatload mmc 0 80001000 init.scr ; then autoscr 80001000 ; else echo no init ; fi ; else echo error mounting SD card ; fi"
