...
#define CFG_NE2000_16BIT
#ifdef CFG_NE2000_16BIT
#define DP_DCR_INIT   (DP_DCR_LS|DP_DCR_FIFO_4|DP_DCR_WTS)
#define DP_IN_DP(_b_, _d_)  (_d_) = *( (volatile unsigned short *) ((_b_ + DP_DATA)))
#define DP_OUT_DP(_b_, _d_) *( (volatile unsigned short *) ((_b_ + DP_DATA))) = (_d_)
#define DP_OUT_DP2(_b_, d1, d2) *( (volatile unsigned short *) ((_b_ + DP_DATA))) = d1 | (d2<<8)
#else
#define DP_DCR_INIT   (DP_DCR_LS|DP_DCR_FIFO_4)
#define DP_IN_DP(_b_, _d_)	(_d_) = *( (volatile unsigned char *) ((_b_ + DP_DATA))); \
				(_d_) |= *( (volatile unsigned char *) ((_b_ + DP_DATA)))<<8
#define DP_OUT_DP(_b_, _d_)	*( (volatile unsigned char *) ((_b_ + DP_DATA))) = (_d_); \
				*( (volatile unsigned char *) ((_b_ + DP_DATA))) = (_d_)>>8
#define DP_OUT_DP2(_b_, d1, d2)	*( (volatile unsigned char *) ((_b_ + DP_DATA))) = d1; \
				*( (volatile unsigned char *) ((_b_ + DP_DATA))) = d2
#endif
